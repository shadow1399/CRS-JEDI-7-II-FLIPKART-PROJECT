...
public class CRSStudentMenu {
	...
	/**
	 * Default values of some state variables.
	 */
	...
	private List<Course> viewCourse(String studentId) {
		...
		for (Course obj : course_available) {
			System.out.println(String.format("%-20s %-20s %-20s %-20s", obj.getCourseId(), obj.getCourseName(),
					obj.getProfessorId(),(10 - obj.getNumberOfStudents())));
		}
		System.out.println("-----------------------------------------------------------------------------------------");
	...
	private List<Course> viewRegisteredCourse(String studentId) {
		...
		for (Course obj : course_registered) {
			...
			System.out.println(
					String.format("%-20s %-20s %-20s ", obj.getCourseId(), obj.getCourseName(), obj.getProfessorId()));
		}
		System.out.println("-----------------------------------------------------------------------------------------");
	...
	private void viewGradeCard(String studentId) {
		...
		System.out.println("Student_ID : " + grade_card.getRollNo());
		System.out.println("Semester : " + grade_card.getSemester());
		System.out.println("GPA : " + grade_card.getGpa());
		
		System.out.println(String.format("%-20s %-20s", "COURSE CODE", "GRADE"));

		for (HashMap.Entry<String, Float> obj : grade_card.getGrades().entrySet()) {
			System.out.println(String.format("%-20s %-20s", obj.getKey(), Float.toString(obj.getValue())));
		}
		System.out.println("-----------------------------------------------------------------------------------------");
	}
	...
	private void make_payment(String studentId) {
		...
		if(viewPayment != null) {
			...
			System.out.println("");
			System.out.print("Student Id :\t\t" + viewPayment.getRollNo());
			System.out.println("");
			System.out.print("Semester :\t\t" + viewPayment.getSemester());
			System.out.println("");
			System.out.print("Status :\t\t" + viewPayment.ispStatus());
			System.out.println("");
			System.out.print("Amount Paid :\t\t" + viewPayment.getpAmout());
			System.out.println("");
			System.out.println("------------------------------------------\n\n");
			return;
		}
		...
		String paymentId ="";
		String ifsc="";
		Float amount = 1000.0f * course_registered.size();
		...
		if(status.equals("success")) pstatus = true;
		Payment pay = new Payment(paymentId,studentId,amount,pstatus,"",notificationId,semester);
